...
const SettingsProfileForm = () => {
    ...
    const handleClick = (e: any) => {
        ...
        const state = dispatch(setUserStatus('verified'));
        localStorage.setItem("filledProfile",state.payload)
    };
                            ...
                            <div className="grid sm:grid-cols-12 gap-2 sm:gap-6 items-center">
                                ...
                                <div className="sm:col-span-9">
                                    <div className="mt-5 flex justify-end gap-x-2">
                                        ...
                                        <button type="submit" className="py-2 px-3 inline-flex btn btn-primary items-center gap-x-2 text-sm  text-white">
                                            Save changes
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="sm:col-span-9">
                                    <div className="sm:flex gap-4 ">
                                        <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                            <input type="text" onChange={handleChange} value={formData.firstName} name="firstName" id="firstName"
                                                className="grow py-4 w-full" placeholder="First Name" required
                                                aria-describedby="firstname-error" />
                                        </label>
                                        <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                            <input type="text" onChange={handleChange} value={formData.lastName} name="lastName" id="lastName"
                                ...
                                <div className="sm:col-span-9">
                                    <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                        <input type="tel" onChange={handleChange} value={formData.phoneNumber} name="phoneNumber" id="phoneNumber"
                                ...
                                <div className="sm:col-span-9">
                                    <div className="space-y-2">
                                        <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                            <input type="date" onChange={handleChange} value={formData.dateOfBirth} name="dateOfBirth" id="dateOfBirth"
                                ...
                                <div className="sm:col-span-9">
                                    <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                        <input type="text" onChange={handleChange} value={formData.nationality} name="nationality" id="nationality"
                                ...
                                <div className="sm:col-span-9">
                                    <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                        <input type="text" onChange={handleChange} value={formData.nameOfInstitution} name="nameOfInstitution" id="nameOfInstitution"
                                ...
                                <div className="sm:col-span-9">
                                    <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                        <input type="text" onChange={handleChange} value={formData.occupation} name="occupation" id="occupation"
                                ...
                                <div className="sm:col-span-9">
                                    <label className="input input-bordered input-primary w-full bg-transparent border  border-gray-300 dark:border-gray-600  py-4 flex items-center gap-3">
                                        <input type="text" onChange={handleChange} value={formData.userRole} name="userRole" id="userRole"
