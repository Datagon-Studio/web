                    ...
                    <form onSubmit={handleClick}>
                        <div className="grid gap-y-4">
                            ...
                            <div className="flex items-center">
                                <div className="flex">
                                    <input id="remember-me" onChange={handleChange} name="rememberMe" type="checkbox" required className="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                    aria-describedby="check-error" />
                                </div>
                                <div className="ms-3">
                                    <label className="text-sm dark:text-white">I accept the <span className="text-primary ">Terms and Conditions</span></label>
                                </div>
                                <p className="hidden text-xs text-red-600 mt-2"
                                    id="check-error">
                                    Please include a valid email address so we can get back to you
                            ...
                            <button type="submit" className="w-full py-4 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary text-white hover:bg-secondary disabled:opacity-50 disabled:pointer-events-none font-bold">Create Account</button>
                        ...
                        <p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 flex justify-center py-3">
                            ...
                            <Link href="/auth/signin" className="text-primary mx-2  decoration-2 hover:underline font-medium dark:text-primary" >
                                Login
                            </Link>
                        </p>
                    </form>
